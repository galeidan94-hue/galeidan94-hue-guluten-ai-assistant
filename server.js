...
const STOPWORDS = new Set(['את','של','עם','אני','אתה','את','יש','אין','זה','זו','על','אם','לא','כן','גם','או','מה','איך','למה','כמה','אפשר','רוצה','רוצים','תמליץ','המלצה','טוב','בשביל','עבור','מוצר','מוצרים','מוצרי','אצלכם','לכם','חנות','באתר','אתר','ללא','גלוטן']);
